...
<br />
	<div id="print">
		<div style = "margin:10px;">	
			<label style = "font-size:18px;"><center>POLYTECHNIC UNIVERSITY OF THE PHILIPPINES - TAGUIG BRANCH DIAGNOSTIC LABORATORY</center></label>
			<label><center>University Health Office - Taguig City</center></label>
