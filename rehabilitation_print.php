...
<br />
	<div id="print">
		<div style = "margin:10px;">
			<img src = "images/pup_logo.png" height = "100px" width = "100px" style = "float:left; position:relative; left:15%;" />
			<div style = "float:right; position:relative; right:35%;">
				<label><center>Republic of the Philippines</center></label>
				<label><center>Polytechnic University of the Philippines</center></label>
				<label><center>City of Taguig</center></label>
				<label><center>University Health Office</center></label>
			</div>
			<br style = "clear:both;" />
			<br />
