	...
	<div id="print">
		<div style = "margin:10px;">	
			...
			<div style = "float:left; margin-left:50px;">	
				<label><center>POLYTECHNIC UNIVERSITY OF THE PHILIPPINES DIAGNOSTIC LABORATORY</center></label>
				<label style = "font-size:14px;"><center>University Health Office - Taguig City</center></label>
